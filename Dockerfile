...
RUN wget -O - -q "$(wget -q https://api.github.com/repos/MatchingAgent/tfsec-pr-commenter-action/releases/latest -O - | grep -o -E "https://.+?commenter-linux-amd64")" > commenter \
